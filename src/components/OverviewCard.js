      ...
      <div className="content">
        <div className="box1">
          <div className="goBackButton">
            <button className="insideButton" onClick={props.showOverview}>
              {" "}
              {"<"}{" "}
            </button>
          </div>
          <h1 className="nameOverview">
        ...
        <div className="box2">
          <div className="subtitle" style={{ marginTop: 15, marginBottom: 6 }}>
            -- Types --
          </div>
          ...
          <div className="subtitle" style={{ marginTop: 20, marginBottom: 6 }}>
            -- Stats --
          </div>
